	<?php echo form_open('management_c/validation_accountUser'); ?>
	<div class="row">
		...
		<a href="<?php echo site_url('management_c/display_management_main'); ?>" class="secondary button radius small"><?php echo lang('del_alert_close');?></a>
