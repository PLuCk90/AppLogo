	<?php echo form_open('salesperson_c/validation_accountUser'); ?>
	<div class="row">
		...
		<a href="<?php echo site_url('salesperson_c/display_salesperson_main'); ?>" class="secondary button radius small"><?php echo lang('del_alert_close');?></a>
