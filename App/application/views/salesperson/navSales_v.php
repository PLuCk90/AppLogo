...
<nav class="top-bar" data-topbar role="navigation" style="-moz-box-shadow: 2px 2px 10px 0px #656565;-webkit-box-shadow: 2px 2px 10px 0px #656565;-o-box-shadow: 2px 2px 10px 0px #656565;box-shadow: 2px 2px 10px 0px #656565;filter:progid:DXImageTransform.Microsoft.Shadow(color=#656565, Direction=134, Strength=10);">  
			<ul class="title-area">
			    <li class="name">
			      <h1><a class="fi-home" href="<?php echo site_url('salesperson_c/display_salesperson_main');?>"> <strong><?php echo lang('topbar_sales_title');  ?></strong></a></h1>
			    </li>
			  ...
			  <section class="top-bar-section">
				<ul class="left">
	 		 			<li ><a class="fi-pricetag-multiple" href="<?php echo site_url(''); ?>"> <?php echo lang('sales_forecast_label');?></a></li> 
				    ...
				    <ul class="right">
				      ...
				      <li class="has-dropdown">
				        ...
				        <ul class="dropdown" style="border:solid 1px #282828;color:#C0C0C0;padding:0px;">
				        	<li><a class="fi-torso " style="margin:0;border:solid 1px #DDDDDD;" href="<?php echo site_url('salesperson_c/manage_my_account/'.$this->session->userdata('id_user')); ?>"> <?php echo lang('my_account_label');?></a></li>
