...
<script type="text/javascript" style="display:none;">
    ...
    users = '<?= json_encode($users);?>';
		...
		<div class="small-10 columns panel" style="margin:0" data-ng-controller="searchController" style="" data-equalizer-watch>
							<table class="responsive" style="">
								<caption><?php echo lang('users_table_header');?></caption>
								<thead>
									<tr>
										<th ><?php echo lang('online_label');?></th>
										<th ><?php echo lang('lastname_label');?></th>
										<th ><?php echo lang('name_label');?></th>
										<th ><?php echo lang('M3code_label');?></th>
										<th ><?php echo lang('M3coor_label');?></th>
									...
									<?php if( $users != NULL): ?>
										<?php foreach ($users as $value): ?>
											<tr id="userRow<?php echo hash("sha256",$value->id_user,FALSE);?>" class="userRow">
												...
												<td><?= ucfirst ($this->users_m->getRightLabel($value->id_right_user)); ?></td>
												<td>
		...
		<div class="small-2 columns panel " style="margin:0" data-equalizer-watch>
			<div class="row">
