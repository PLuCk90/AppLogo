	<?php echo form_open('coordinator_c/validation_accountUser'); ?>
	<div class="row">
		...
		<a href="<?php echo site_url('coordinator_c/display_coordinator_main'); ?>" class="secondary button radius small"><?php echo lang('del_alert_close');?></a>
